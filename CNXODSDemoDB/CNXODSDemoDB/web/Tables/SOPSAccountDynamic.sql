CREATE TABLE [web].[SOPSAccountDynamic] (
    ...
    CONSTRAINT [FK_SOPSAccountDynamic_SOpsAccountId] FOREIGN KEY ([SOpsAccountId]) REFERENCES [web].[SOpsAccount] ([SOpsAccountId]),
...
CREATE NONCLUSTERED INDEX [IX_SOPSAccountDynamic_SOpsAccountId]
    ON [web].[SOPSAccountDynamic]([SOpsAccountId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_SOPSAccountDynamic_OdsAccountId]
    ON [web].[SOPSAccountDynamic]([OdsAccountId] ASC);
