CREATE TABLE [dbo].[SOpsAccountReview] (
    ...
    CONSTRAINT [FK_SOpsAccountReview_SOpsAccountId] FOREIGN KEY ([SOpsAccountId]) REFERENCES [dbo].[SOpsAccount] ([SOpsAccountId])
);


GO
CREATE NONCLUSTERED INDEX [IX_SOpsAccountReview_SOpsReviewSupportId]
    ON [dbo].[SOpsAccountReview]([SOpsReviewSupportId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_SOpsAccountReview_SOpsCallPlanId]
    ON [dbo].[SOpsAccountReview]([SOpsCallPlanId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_SOpsAccountReview_SOpsTerritoryId]
    ON [dbo].[SOpsAccountReview]([SOpsTerritoryId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_SOpsAccountReview_SOpsAccountId]
    ON [dbo].[SOpsAccountReview]([SOpsAccountId] ASC);
